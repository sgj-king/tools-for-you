...
import { tool as stickyNotes } from './sticky-notes';
import { tool as worldClock } from './world-clock';
import { tool as waterTracker } from './water-tracker';
import { tool as breathingExercise } from './breathing-exercise';
import { tool as boxShadowGenerator } from './box-shadow-generator';
import { tool as pomodoroTimer } from './pomodoro-timer';
import { tool as bmiCalculator } from './bmi-calculator';
import { tool as billSplitter } from './bill-splitter';
import { tool as attendanceCalculator } from './attendance-calculator';
import { tool as fuelCostCalculator } from './fuel-cost-calculator';
...
import { tool as cssAnimationGenerator } from './css-animation-generator';
import { tool as currencyConverter } from './currency-converter';
import { tool as privacyRedactor } from './privacy-redactor';
import { tool as electricityCostCalculator } from './electricity-cost-calculator';
...
export const toolsByCategory: ToolCategory[] = [
  ...
  },
  {
    ...
    components: [
      ...
      numeronymGenerator,
      asciiTextDrawer,
      markdownEditor, markdownTableGenerator, stickyNotes, privacyRedactor,
    ],
  },
  {
    name: '数据工具',
